...
class TIAGo():
    def __init__(self, id):
        ...
        #Creation of the availability publisher
        self.publisher_availability = rospy.Publisher('availability', String, queue_size=10)#Creation of a publisher that will publish String messages to the 'availability' topic
        rospy.init_node('TIAGo_availability', anonymous=True) #ROS node of the TIAGo robot
        

        self.publisher_position = rospy.Publisher('position', Point, queue_size=10)#Creation of a publisher that will publish Point (position) messages to the 'position' topic
        rospy.init_node('TIAGo_position', anonymous=True) #ROS node of the TIAGo robot
